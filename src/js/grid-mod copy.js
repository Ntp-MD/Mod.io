...
const GRID_MOD_CONFIG = {
  TogglePrecision: true, // true = use TogglePrecision, false = use GridTemplate
};
...
function applySmartGridStyles(element, attrs) {
  ...
  const gap = validateCSSVariable(attrs.gap) || getComputedVariable("--gap-sm") || "16px";
  element.style.gap = gap;
